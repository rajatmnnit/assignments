...
## 1. Goal
<!-- Define: **What**
It should be a business description of the problem statement, not the technical aspects describing the model.
--> 
...
## 4. Execution Plan
<!-- Define: **How**
Remember, only define "how", not implement it. Do NOT discuss implementation details like the type of models which will be used in the solution.
-->
### a. Data Sources
<!-- If it known where the data will come from, mention it. Remember, do not write the details of how the data will be cleaned up and/or processed. Just list the high level sources and nature of data -->

&nbsp;

## 5. Deployment Plan
<!-- Define: **How and Where**
Discuss how the models built will be deployed and where. What will be the process to test/update the models?
-->

&nbsp;

## 6. Resources
<!-- It may make sense to estimate the amount of resources this project will require. If the project requires any specialized environment or hardware to be deployed and run, mention it.
-->
### a. Human Resources
### b. Machine Resources
